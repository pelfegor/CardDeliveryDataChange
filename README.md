# CardDeliveryDataChange [![Build status](https://ci.appveyor.com/api/projects/status/g4jko28ccces5wft?svg=true)](https://ci.appveyor.com/project/pelfegor/carddeliverydatachange)
